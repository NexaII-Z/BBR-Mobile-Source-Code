...
public class FirstPrizeScript : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		if (Physics.Raycast(transform.position, direction, out raycastHit, float.PositiveInfinity, 769, QueryTriggerInteraction.Ignore) & raycastHit.transform.tag == "Player")
		{
